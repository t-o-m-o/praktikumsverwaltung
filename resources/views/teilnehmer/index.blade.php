...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="btn-group">
            <div class=".col-sm-4 ml-1"><a href="{{url()->previous()}}" class="btn btn-info"> zurück</a></div>
            <div class=".col-sm-4 ml-1"><a href="{{Route('teilnehmer.create')}}" class="btn btn-info"> Teilnehmer
                    hinzufügen</a>
            </div>
        </div>
    </div>
